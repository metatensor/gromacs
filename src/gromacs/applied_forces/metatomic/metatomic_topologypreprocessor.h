...
/*! \internal \file
 * \brief
 * MetatomicTopologyPrepocessor class responsible for
 ...
 */
class MetatomicTopologyPreprocessor : public QMMMTopologyPreprocessor
{
public:
    /*! \brief Constructor for MetatomicTopologyPreprocessor from its parameters
     *
     * \param[in] inputIndices Array with global indices of NN input atoms
     */
    MetatomicTopologyPreprocessor(ArrayRef<const Index> inputIndices);
